...
class _PredictMoreState extends State<PredictMore> {
  final String _url = 'http://192.168.219.54:3000/predsql/predselect'; // 서버 URL
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse is Map<String, dynamic>) {
          ...
          setState(() {
            ...
            print("단일 객체인 경우 : ${_tbPrediction[0].created_at}");
          });
          ...
          setState(() {
            _tbPrediction = predictions;
            print(" _tbPrediction : ${_tbPrediction}");
          });
        } else {
          setState(() {
  ...
  void _updateChartData() {
    setState(() {
      ...
      if (_tbPrediction.isNotEmpty) {
        ...
        print("predDates : ${predDates}");
        print("predPowers : ${predPowers}");

...
recruitrou.post('/bselect', async (req, res) => {
  ...
  recruitrou.post('/addrecruit', async (req, res) => {
    ...
    try {
      ...
      const sql2 = `insert into TB_SOLAR_BOARD values(SEQ_RECRUIT_IDX.NEXTVAL, '${solarplant.sb_type[0]}', ${parseInt(solarplant.plant_power[0])}, '${solarplant.mem_id[0]}', '${solarplant.place[0]}')`;

...
class _RecruitMoreState extends State<RecruitMore> {
  final String _url = 'http://192.168.219.54:3000/recruitsql/bselect'; // 서버 URL
  ...
  final String _url2 = 'http://192.168.219.54:3000/recruit/recruitmore';
  ...
  // 참여하기 버튼 상태 받아오기
  final String _url3 = 'http://192.168.219.54:3000/recruit/participate';
  late List<String> par = [];
      ...
      if (response3.statusCode == 200) {
        if (jsonResponse is Map<String, dynamic>) {
          ...
          setState(() {
            ...
            print('단일 객체인 경우 ${_recruitcomment[0].PLACE}');
              par = [recruitcomment2] as List<String>;
              print('님피아');
          ...
          // 배열인 경우
          final recruitcomment2 = jsonResponse.map((data) {
            if (data is Map<String, dynamic>) {
              return RecruitComment2.fromJson(data);
            } else {
              return null; // 데이터가 올바른 형식이 아닌 경우
            }
          }).whereType<RecruitComment2>().toList();
  ...
  // 참여하기 버튼 활성화하기
  final String _url4 = 'http://192.168.219.54:3000/recruit/participateadd';

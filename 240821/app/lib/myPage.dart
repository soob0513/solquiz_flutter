...
class _MyPageState extends State<MyPage> {
  ...
  //-----------------------------------------------------------
  // 1. userInfo : _sendQuery()
  final String _url = 'http://192.168.219.54:3000/login/mypage';

  // 2. 참여현황 리스트 띄우기 + percent를 띄워보자 : _recruit_more()
  final String _url2 = 'http://192.168.219.54:3000/recruit/myrecruit';

  // 3. 발전소 모집 현황 모집 마감 버튼 : _b_state()
  final String _url3 = 'http://192.168.219.54:3000/mypage/bstate';

  // 4. 모집마감 버튼 상태 바꾸기 : _change_sta()
  final String _url4 = 'http://192.168.219.54:3000/mypage/bchange';

  // 5. 승인 대기 -> 완료로 바꾸기  : _change_wait()
  final String _url5 = 'http://192.168.219.54:3000/mypage/mypagewait';

  // 6. 발전소 모집 현황에서 모집글로 이동 : _my_recruit_more()
  final String _url6 = 'http://192.168.219.54:3000/mypage/mypagerecruit';
  //-------------------------------------------------------------
      ...
      if (response2.statusCode == 200) {
        ...
        if (jsonResponse is Map<String, dynamic>) {
          ...
          setState(() {
            ...
            powerList = _recruitcomment[0].PLANT_POWER.map((e) => int.parse(e!)).toList();
              ...
              : Center(
                ...
                children: [
                        ...
                        Row(
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: (){Navigator.pushNamed(context, '/plantinfo');} ,
                  ...
                  Container(
                    ...
                    child: _recruitcomment.isEmpty || powerList == []
                        ? Center(child: CircularProgressIndicator(
                      color: Colors.white,
                    ))
                        : Column(
